...
val string_of_scope :
  ...
  (** Serialize a value of type {!type:scope}
      into a JSON string.
...
val string_of_app :
  ?len:int -> app -> string
  (** Serialize a value of type {!type:app}
      into a JSON string.
      @param len specifies the initial length
                 of the buffer used internally.
                 Default: 1024. *)
...
val write_authorization_response :
  Buffer.t -> authorization_response -> unit
...
val string_of_authorization_response :
  ...
  (** Serialize a value of type {!type:authorization_response}
      into a JSON string.
      @param len specifies the initial length
                 of the buffer used internally.
                 Default: 1024. *)
...
val write_authorization_request :
  Buffer.t -> authorization_request -> unit
...
val string_of_authorization_request :
  ...
  (** Serialize a value of type {!type:authorization_request}
      into a JSON string.
      @param len specifies the initial length
                 of the buffer used internally.
                 Default: 1024. *)
